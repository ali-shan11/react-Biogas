    ...
    <>
      <div className="layout-right-side reports-graph">
        <Container className="text-center">
          ...
          <Link to={`${process.env.PUBLIC_URL}/reports/reportsattributetwo`} className="report-info-btn px-4 py-2 rounded-pill ">Change Attributes</Link>
          </Row>
          <Col>
